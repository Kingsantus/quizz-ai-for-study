...
const neoClasses = "w-full rounded-full px-3.5 py-5 border-2 relative z-10 text-lg font-bold hover:transform hover:translate-y-[-2px] transition-transformduration-200";
...
export const spanVariants = cva(
  ["absolute", "h-14", "buttom-[-7px]", "w-full", "border-2", "left-0", "z-0"], {
    variants: {
      variant: {
        default: "hidden",
        destructive: "hidden",
        ...
        neoSuccess: "border-green-500 border-green-600",
        neoDanger: "border-red-500 border-red-600"
      },
    },
    defaultVariants: {
      variant: "default"
